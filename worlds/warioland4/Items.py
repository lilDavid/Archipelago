...
box_table = {
    ...
    ItemName.forty_below_fridge.cd: ItemData(57005, False),
    ItemName.pinball_zone.cd: ItemData(57006, False),
    ...
    # Topaz Passage
    ItemName.toy_block_tower.cd: ItemData(57007, False),
    ItemName.big_board.cd: ItemData(57008, False),
    ItemName.doodle_woods.cd: ItemData(57009, False),
    ItemName.domino_row.cd: ItemData(57010, False),
    ...
    # Sapphire Passage
    ItemName.crescent_moon_village.cd: ItemData(57011, False),
    ItemName.arabian_night.cd: ItemData(57012, False),
    ItemName.fiery_cavern.cd: ItemData(57013, False),
    ItemName.hotel_horror.cd: ItemData(57014, False),
